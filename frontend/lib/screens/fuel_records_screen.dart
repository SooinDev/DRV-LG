...
class _FuelRecordsScreenState extends State<FuelRecordsScreen>
  ...
  Widget _buildFuelRecordCard(FuelRecord record, bool isDark) {
    return Container(
                      ...
                      decoration: BoxDecoration(
                        gradient: LinearGradient(
                          ...
                          colors: isDark
                              ...
                              : [AppTheme.lightAccent, AppTheme.lightPrimary],
                        ),
                        borderRadius: BorderRadius.circular(16),
                        boxShadow: [
                          BoxShadow(
                  ...
                  children: [
                    ...
                    Expanded(
                      child: _buildInfoCard(
                        ...
                        label: '총 금액',
                        value: '₩${NumberFormat('#,###').format(record.totalPrice)}',
                        color: isDark
